...
```bash
server running om port 5173
```

Visit `http://localhost:5173/test` in your browser just to confirm routes are configured and working properly. If all is working properly, you should get the below response on browser.
