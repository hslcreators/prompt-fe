		...
		<React.Fragment>
			<div className="flex flex-col pt-[3vw] pb-[7vw] lg:pt-[4vw] lg:pb-[6vw] nxl:pt-[1vw] nxl:pb-[4vw] text-[#4A5568] font-bold vsm:text-[5.2vw] lg:text-[20px] xl:text-[30px]">
				<div className="flex flex-row vsm:mb-0">
					<div className=" mr-[1.5vw] lg:mr-[8px] xl:mr-[16px]">Hello { user.first_name }!</div>
				...
				<div className="w-100% max-w-[1048px] h-100%  mt-[10px]">
					<img
				...
				<div className="flex flex-row justify-between font-normal vsm:text-[3.5vw] sm:text-[18px] pt-[20px]">
					<div>Vendors</div>
					<button className="text-[#524ECA] flex flex-row sm:text-[14px] lg:text-[11px] xl:text-[15px] underline" onClick={() => {
						startTransition(() => {
							navigate('/vendors')
						})
					}}>View All</button>
