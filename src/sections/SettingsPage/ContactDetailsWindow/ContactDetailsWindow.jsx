import './contactDetailsWindow.css'
import { popoutWindow } from '@/pages/SettingsPage'

const ContactDetailsWindow = ({ isContact }) => {
    return (
        <div className={`contact-details-window settings-windows ${isContact? `active` : false}`}>
...
export default ContactDetailsWindow